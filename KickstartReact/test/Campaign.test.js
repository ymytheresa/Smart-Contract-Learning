...
beforeEach(async () => {
  ...
  [campaignAddress] = await factory.methods.getDeployedCampaigns().call();//take the first element of the return array and assign it to the variable
  campaign = await new web3.eth.Contract(compiledCampaign.abi, campaignAddress);//return array of campaign
});
